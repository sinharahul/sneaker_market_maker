# 17 — Control-plane acceptance — iql_primary

**What to build:** Acceptance at the Paper Ops Control Plane: qualified stub IQL, set `iql_primary`, tick golden replay; assert authorship, pause-on-failure, and recovery via mode switch or healthy inference.
