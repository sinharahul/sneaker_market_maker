...
def status_projection(
    *,
    ...
    action_translator_version: str | None = None,
    unlocked_modes: list[str] | None = None,
    last_promote: dict[str, Any] | None = None,
    ...
    return {
        ...
        "registry": {
            ...
            "artifact_hash": registry_artifact_hash,
            "encoder_version": encoder_version,
            "state_schema_version": state_schema_version,
            "action_translator_version": action_translator_version,
            "unlocked_modes": unlocked_modes or [],
        },
